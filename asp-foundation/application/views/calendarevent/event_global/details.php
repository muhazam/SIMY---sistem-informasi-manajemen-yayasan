<section class="content-header">
  <h1>
    <i class="fa fa-users">
      ...
      <small>Detail  &nbsp
      <?php echo anchor('calendar_global/modul', ' ', array('class' => 'fa fa-reply btn btn-success btn-xs btn-flat', 'title' => 'back')); ?>

      </small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="welcome"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Details Calendar Events</li>
  </ol>
</section>
    ...
    <div class='col-xs-12'>
      <div class='box box-success'>            
        <div class="box-header ">
          <li class="box-title">Detail Calendar Events</li>
        </div>
          <div class="box-body">
            <div class='col-xs-12'>
