...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("calendar_global/add_event"), array("class" => "form-horizontal")) ?>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <?php echo form_open(site_url("calendar_global/edit_event"), array("class" => "form-horizontal")) ?>
      <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Nama Event</label>
                <div class="col-md-8 ui-front">
    ...
    $('#calendar').fullCalendar({
        eventSources: [
           ...
           events: function(start, end, timezone, callback) {
                $.ajax({
                    url: '<?php echo base_url() ?>calendar_global/get_events',
                    dataType: 'json',
                    data: {
