<section class="content-header">
  <h1>
    <i class="glyphicon glyphicon-user">
      ...
      Management Calendar Events Ma'had
      <small>Modul Calendar Events Ma'had</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="welcome"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Modul Calendar Events Ma'had</li>
  </ol>
</section>
        ...
        <div class="col-xs-12">
          <div class="box box-success panel panel-success">
            <div class="panel-heading breadcrumb">
              <li class="fa fa-external-link-square"></li>&nbsp DATA CALENDAR EVENTS MA'HAD&nbsp &nbsp 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script>
    $(document).ready(function() {
        var t = $('#mytable').DataTable( {
            "responsive": true,
            "scrollX": true,
            "ajax": "<?php echo site_url('calendar_mahad/data'); ?>",
            "order": [[ 1, 'asc' ]],
