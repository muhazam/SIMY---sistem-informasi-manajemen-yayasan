<section class="content-header">
  ...
  <i class="glyphicon glyphicon-calendar"></i>
    Calendar Events Ma'had
    <small>Control panel</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="welcome"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Calendar Events Ma'had</li>
  </ol>
</section>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Calendar Event Ma'had</h4>
      </div>
      <div class="modal-body">
      <?php echo form_open(site_url("calendar_mahad/add_event"), array("class" => "form-horizontal")) ?>
      <div class="form-group">
        ...
        <div class="form-group">
                ...
                <div class="col-md-8 input-append date form_datetime">
                    <input class="form-control" type="text" value="" name="start_date">
        ...
        <div class="form-group">
                ...
                <div class="col-md-8 input-append date form_datetime">
                    <input class="form-control" type="text" value="" name="end_date">
                    <span class="add-on"><i class="icon-th"></i></span>
                </div>
        </div>
      </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <?php echo form_open(site_url("calendar_mahad/edit_event"), array("class" => "form-horizontal")) ?>
      <div class="form-group">
                <label for="p-in" class="col-md-4 label-heading">Nama Event</label>
                <div class="col-md-8 ui-front">
    ...
    $('#calendar').fullCalendar({
        eventSources: [
           ...
           events: function(start, end, timezone, callback) {
                $.ajax({
                    url: '<?php echo base_url() ?>calendar_mahad/get_events',
                    dataType: 'json',
                    data: {
