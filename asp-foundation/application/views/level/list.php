<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Level Users</li>
  </ol>
</section>
        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header breadcrumb">
              <li class="box-title">Data Modul Level Users</li>&nbsp &nbsp 
              <li>  
                <?php 
                    echo anchor('level/add', '<i class="fa fa-plus-circle" aria-hidden="true"></i>', 'class="btn btn-xs btn-success btn-flat" title="Tambah Data"');
                ?>&nbsp
              </li>
            </div>
            <!-- /.box-header -->
                  ...
                  <div class="col-sm-12">
                    ...
                    <table id="mytable" class="table table-bordered table-hover table-responsive dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        <tr>
                          <th>NO</th>
                          <th class="sorting">NAMA LEVEL</th>
                          <th>AKSI</th>
                        </tr>
                      </thead>
...
<script>
    $(document).ready(function() {
        var t = $('#mytable').DataTable( {
            "responsive": true,
            "scrollX": true,
            "ajax": "<?php echo site_url('level/data'); ?>",
            "order": [[ 1, 'asc' ]],
            ...
            "columns": [
                ...
                { "data": "nama_level", 'sClass': 'text-center'},
