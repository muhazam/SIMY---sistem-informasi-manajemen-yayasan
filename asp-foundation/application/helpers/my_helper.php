<?php
	// MSG
	public function show_msg($content='', $type='success', $icon='fa-info-circle', $size='14px') {
		if ($content != '') {
	...
	public function show_succ_msg($content='', $size='14px') {
		if ($content != '') {
			return   '<p class="box-msg">
	...
	public function show_err_msg($content='', $size='14px') {
		if ($content != '') {
			return   '<p class="box-msg">
	...
	public function show_my_confirm($id='', $class='', $title='Konfirmasi', $yes = 'Ya', $no = 'Tidak') {
		$_ci = &get_instance();
